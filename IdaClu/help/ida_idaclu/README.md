...
***IdaClu*** is an ***IDAPython*** plugin without external package dependencies. No building is required. It can be installed by downloading the repository and copying file ***ida_clu.py*** and folder ***idaclu*** to your ***IDA Pro*** plugin directory:

- *C:\Program Files\IDA Pro \<IDA_VERSION\>\plugins*
- *C:\Users\harlamovs.s\AppData\Roaming\Hex-Rays\IDA Pro\plugins*
...
```sh
:: C:\Users\<username>\AppData\Roaming\Hex-Rays\IDA Pro\plugins\ida_clu.py
> mklink "C:\Program Files\IDA Pro X.X\plugins\ida_clu.py" <plugin_path>\ida_clu.py
...
```sh
% ln -s <plugin_path>\ida_clu.py /Users/<username>/.idapro/plugins/ida_clu.py
