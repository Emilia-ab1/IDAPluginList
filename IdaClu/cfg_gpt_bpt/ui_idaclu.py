...
class Ui_PluginDialog(object):
    ...
    def setupUi(self, PluginDialog):
        ...
        self.wConfigFrame = ConfigFrame(self.env_desc, 'config', self.stackedWidget)

        # self.stackedWidget.addWidget(self.wResultsView)
        # self.stackedWidget.addWidget(self.wConfigFrame)
        ...
        self.sToolsMidExt = QSpacerItem(10, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
        self.sToolsMidInt = QSpacerItem(10, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
        self.sToolsMidRst = QSpacerItem(10, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.lToolsSep1 = QFrame(self.MainFrame)
        # self.lToolsSep1.setObjectName(u"lToolsSep1")
        self.lToolsSep1.setFrameShape(QFrame.VLine)
        self.lToolsSep1.setFrameShadow(QFrame.Sunken)

        self.wButtonTool = ButtonTool(u"ButtonTool", self.env_desc, self.MainFrame)
        self.wButtonTool.setObjectName(u"wButtonTool")
        self.wButtonTool.setMinimumSize(QSize(30, 30))
        self.wButtonTool.setMaximumSize(QSize(16777215, 30))

        self.ToolsLayout.addItem(self.sToolsMidExt)
        self.ToolsLayout.addWidget(self.lToolsSep1)
        self.ToolsLayout.addItem(self.sToolsMidInt)
        self.ToolsLayout.addWidget(self.wButtonTool)
        self.ToolsLayout.addItem(self.sToolsMidRst)
        self.ToolsLayout.addWidget(self.lToolsSep1)
        self.ToolsLayout.addItem(self.sToolsMidRst)
        ...
        self.sToolsEnd2 = QSpacerItem(50, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.wConfigButton = QPushButton(self.MainFrame)
        self.wConfigButton.setMinimumSize(QSize(30, 30))
        self.wConfigButton.setMaximumSize(QSize(30, 30))
        self.wConfigButton.setFont(font1)
        self.wConfigButton.setCheckable(False)
        self.wConfigButton.setCursor(QCursor(Qt.PointingHandCursor))
        icon = QIcon(':/idaclu/icon_64.png')  # Replace 'icon.png' with the path to your icon file
        self.wConfigButton.setIcon(icon)

        self.ToolsLayout.addItem(self.sToolsEnd2)
        self.ToolsLayout.addWidget(self.wConfigButton)
